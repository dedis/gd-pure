...
lemma test1: "x N \<Longrightarrow> x+1 = 1 \<Longrightarrow> x+2 = 2"
  apply (induct x)
(* 
proof (prove)
goal (2 subgoals):
 1. x N \<Longrightarrow> x + Szero = Szero \<Longrightarrow> zero + SSzero = SSzero
 2. \<And>xa. x N \<Longrightarrow> x + Szero = Szero \<Longrightarrow> xa N \<Longrightarrow> xa + SSzero = SSzero \<Longrightarrow> Sxa + SSzero = SSzero
*)
  sorry
...
goal (3 subgoals):
 1. x N
 2. zero + SSzero = SSzero
 3. \<And>x. x N \<Longrightarrow> x + SSzero = SSzero \<Longrightarrow> Sx + SSzero = SSzero
*)
  sorry

lemma test3: "x N \<Longrightarrow> x+1 = 1 \<Longrightarrow> x+2 = 2"
proof (rule ind[where a = "x"])
  show "x N \<Longrightarrow> x + S zero = S zero \<Longrightarrow> x N"
    sorry

  show " x N \<Longrightarrow> x + S zero = S zero \<Longrightarrow> zero + S S zero = S S zero"
    sorry

  show "  \<And>xa. x N \<Longrightarrow> x + S zero = S zero \<Longrightarrow> xa N \<Longrightarrow> xa + S S zero = S S zero \<Longrightarrow> S xa + S S zero = S S zero"
    sorry
...
proof (rule ind[where a = "x"])
  ...
  show "zero + S S zero = S S zero"
    sorry

  show "  \<And>x. x N \<Longrightarrow> x + S S zero = S S zero \<Longrightarrow> S x + S S zero = S S zero "
    sorry

qed

lemma test5: "(x N) \<longrightarrow> x+1 = 1 \<longrightarrow> x+2 = 2"
  apply (induct x)
(* 
proof (prove)
goal (3 subgoals):
 1. x N
 2. (zero N) \<longrightarrow> zero + Szero = Szero \<longrightarrow> zero + SSzero = SSzero
 3. \<And>x. x N \<Longrightarrow> (x N) \<longrightarrow> x + Szero = Szero \<longrightarrow> x + SSzero = SSzero \<Longrightarrow> (Sx N) \<longrightarrow> Sx + Szero = Szero \<longrightarrow> Sx + SSzero = SSzero
*)
  sorry
